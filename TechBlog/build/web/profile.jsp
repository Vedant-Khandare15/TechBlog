    ...
    <nav class="navbar navbar-expand-lg navbar-dark primary-background-color">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal"> <span class="fa fa-envelope-open-o"></span> Do Post</a>
                </li>
            </ul>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-8" >
                    ...
                    <div class="container text-center " id="loader">
                        ...
                        <h3 class="container mt-2">Loading..</h3>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container text-center">
                        ...
                        <!-- Corrected id attribute for profile-details -->
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= (user.getDateTime() != null) ? user.getDateTime().toString() : "N/A"%></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div id="profile-edit" style="display: none;">
                            ...
                            <form action="EditServlet" methods="post" enctype="multipart/form-data" > 
